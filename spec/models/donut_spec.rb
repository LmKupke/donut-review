...
RSpec.describe Donut, type: :model do
  ...
  it { should have_valid(:image).when("http://kitchenconfidante.com/wp-content/uploads/2013/02/Baked-Coconut-Doughnuts-Kitchen-Confidante-3.jpg", "http://alloveralbany.com/images/schuyler_glazed_donut.jpg")}
